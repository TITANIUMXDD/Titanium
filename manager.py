...
'     ──╚╝─╚══╝─╚╝─╚╝─╚╩╝─╚═╩══╩═══╩╝╚╝╚╝',             
    ...
    for char in b:
        print(f'{ye}{char}{rs}')
    #print("A Titanium Project")
    print(f'{lg}   Version: {ye}1{lg} | Author:{ye}@SHIVAMIPA & @SH4DOW_OWNER\n')
...
while True:
    ...
    if a == 1:
        ...
        try:
            version = requests.get('https://raw.githubusercontent.com/TITANIUMXDD/Titanium/main/version.txt')
        except:
        ...
        if float(version.text) > 1.1:
            ...
            if prompt == 'y' or prompt == 'yes' or prompt == 'Y':
                ...
                os.system('curl -l -O https://raw.githubusercontent.com/TITANIUMXDD/Titanium/main/add.py')
                os.system('curl -l -O https://raw.githubusercontent.com/TITANIUMXDD/Titanium/main/manager.py')
            ...
            print(f'{lg}[i] Your Titanium is already up to date')
            input('Press enter to goto main menu...')
    elif a == 5:
        clr()
        banner()
